...
public class GestureSettings extends PreferenceFragment implements
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mProxiSwitch.setChecked(Settings.System.getInt(getContext().getContentResolver(),
                Settings.System.ZEN_DEVICE_PROXI_CHECK_ENABLED, 1) != 0);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mProxiSwitch) {
            Settings.System.putInt(getContext().getContentResolver(),
                    Settings.System.ZEN_DEVICE_PROXI_CHECK_ENABLED, mProxiSwitch.isChecked() ? 1 : 0);
            return true;
        }
    ...
    private void setGestureEnabled(int id, boolean enabled) {
        ...
        String gestureTypeMapping = Settings.System.getString(getContext().getContentResolver(), Settings.System.ZEN_BUTTON_EXTRA_KEY_MAPPING);
        Settings.System.putString(getContext().getContentResolver(), Settings.System.ZEN_BUTTON_EXTRA_KEY_MAPPING, gestureType);
