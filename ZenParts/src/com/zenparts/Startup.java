...
public class Startup extends BroadcastReceiver {
    private static void restore(String file, boolean enabled) {
        ...
        ZenUtils.writeValue(file, enabled ? "1" : "0");
    }
    ...
    private static void restore(String file, String value) {
        ...
        ZenUtils.writeValue(file, value);
    }
    ...
    private void maybeImportOldSettings(Context context) {
        boolean imported = Settings.System.getInt(context.getContentResolver(), "zen_device_setting_imported", 0) != 0;
        if (!imported) {
            ...
            Settings.System.putInt(context.getContentResolver(), "zen_device_setting_imported", 1);
        }
    }
    ...
    public static void restoreAfterUserSwitch(Context context) {
        ...
        value = Settings.System.getString(context.getContentResolver(), Settings.System.CUSTOM_BUTTON_EXTRA_KEY_MAPPING);
