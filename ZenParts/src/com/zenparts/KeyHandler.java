...
import com.android.internal.util.os.AlternativeDeviceKeyHandler;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ZEN_DEVICE_PROXI_CHECK_ENABLED),
                    false, this);
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ZEN_DEVICE_FEATURE_SETTINGS),
                    false, this);
        ...
        public void update() {
            mUseProxiCheck = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.ZEN_DEVICE_PROXI_CHECK_ENABLED, 1,
